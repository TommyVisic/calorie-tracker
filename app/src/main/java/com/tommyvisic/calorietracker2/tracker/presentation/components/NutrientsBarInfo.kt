...
/**
 * The circular indicators in the tracker feature - one each for carbs, protein and fat.
 */
@Composable
fun NutrientsBarInfo(
    ...
    Box(
        ...
        val textColor = if(value <= goal) MaterialTheme.colors.onPrimary else goalExceededColor
